...
(* OASIS_START *)
(* DO NOT EDIT (digest: 64bd6c810cab12733c3b9353c425effc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/xvw/ppx_debugger";
          synopsis = "An interactive debugger for OCaml";
          description =
            Some [OASISText.Para "A small preprocessor for OCaml debugging"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_debugger"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ppx_debugger";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_debugger.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¢¸ýrÞ7]S\023Zw\bÝC¦^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
